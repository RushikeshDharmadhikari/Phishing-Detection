...
namespace Sample_CSharp_API_Client
{
    public class whois
    {
        ...
        {
            Instantiate("google.com");
        }*/

        public static void Instantiate(string argsDomainName)
        {
            //////////////////////////
        ...
        public class WhoisRecord
        {
            ...
            public string [] getRequiredInformation()
            {
                ...
                information[0] = domainName.ToString();
                information[0] = createdDate.ToString();
                information[1] = updatedDate.ToString();
                information [2] = expiresDate.ToString();
                return information;
            }
